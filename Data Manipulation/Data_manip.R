setwd("F:\\Work\\Jigsaw Academy\\Data Scientist Course\\Data Science Redo\\Data Manipulation")
oj <- read.csv("F:/Work/Jigsaw Academy/Data Scientist Course/Data Science Redo/Data Manipulation/oj.csv")
